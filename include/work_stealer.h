...
class WorkStealer
{
    public:
        ...
        bool finished();
        void poll_incoming_requests(std::deque<GhostTree>& myqueue, double& my_poll_time, double& my_response_time, int& num_trees_stolen, int& num_steal_reqs_recv, int& num_steal_reqs_sent);
